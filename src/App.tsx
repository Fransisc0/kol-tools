...
import { useTCRSData } from './hooks/useTCRSData';
...
export default function App() {
  ...
  const { data, loading, error, isColdStart, retry } = useTCRSData(selectedClass, selectedSign);
            ...
            <div className="flex-1 flex flex-col items-center justify-center py-20 sm:py-32 text-slate-500 bg-white rounded-2xl border border-slate-200 shadow-xs">
              ...
              {isColdStart && (
                <div
                  ...
                  role="status"
                >
                  The free data service is waking up. The first visit after a quiet period can take about a
                  minute.
                  <button
                    type="button"
                    onClick={retry}
